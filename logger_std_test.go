...
func TestStdLtreeTrim(t *testing.T) {
	var buf bytes.Buffer
	std = New(LEVEL_DEBUG, &buf)
	SetFlags(Llabel | LtreeTrim | LshowIndent)

	Debugln("Level 0 Output 1")
	lvl7 := func() { Debugln("Level 3 Output 1") }
	lvl6 := func() { lvl7() }
	lvl5 := func() {
		Debugln("Level 2 Output 1")
		Debugln("Level 2 Output 2")
		lvl6()
		Debugln("Level 2 Output 3")
	}
	lvl4 := func() { lvl5() }
	lvl3 := func() { lvl4() }
	lvl2 := func() { lvl3() }
	lvl1 := func() {
		Debugln("Level 1 Output 1")
		Debugln("Level 1 Output 2")
		lvl2()
		Debugln("Level 1 Output 3")
	}
	lvl1()
	Debugln("Level 0 Output 2")
